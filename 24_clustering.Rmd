...
mae[[1]] <- transformCounts(mae[[1]], method = "relabundance", pseudocount = 1)
mae[[1]] <- transformCounts(mae[[1]], "relabundance", method = "clr")
```
...
mae[[1]] <- transformCounts(mae[[1]], assay_name = "clr",
                            MARGIN = "features",
                            method = "z", name = "clr_z")
