...
tse_phylum <- transformCounts(tse_phylum, method = "relabundance", pseudocount = 1)
...
tse_phylum_subset <- transformCounts(tse_phylum_subset, method = "relabundance", pseudocount = 1)
tse_phylum_subset <- transformCounts(tse_phylum_subset, method = "clr", assay_name = "relabundance")
