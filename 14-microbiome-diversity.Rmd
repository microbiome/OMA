...
freq_yes <- table(as.character(most_abundant[colData(TreeSE_Genus)$alcohol=="yes"]))
freq_no <- table(as.character(most_abundant[colData(TreeSE_Genus)$alcohol=="no"]))
percent_yes <- round(freq_yes/sum(freq_yes)*100, 1)
percent_no <- round(freq_no/sum(freq_no)*100, 1)

# Visualization
plotReducedDim(TreeSE_Genus[,colData(TreeSE_Genus)$alcohol=="yes"],
                          "PCoA", colour_by = "most_abundant") +
  scale_colour_manual(values = c("black", "blue", "lightblue", "darkgray", "magenta", "darkgreen", "red"),
...
plotReducedDim(TreeSE_Genus[,colData(TreeSE_Genus)$alcohol=="no"],
                          "PCoA", colour_by = "most_abundant") +
  scale_colour_manual(values = c("black", "blue", "lightblue", "darkgray", "magenta", "darkgreen", "red"),
