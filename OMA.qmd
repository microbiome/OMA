...
```{r}
#| label = "plot-prev-prev",
#| message = FALSE,
#| fig.cap = "Prevalence of top phyla as judged by prevalence"
library(miaViz)
...
```{r}
#| label = "plot-prev-mean",
#| message = FALSE,
#| fig.cap = "Prevalence of top phyla as judged by mean abundance"
...
```{r}
#| label = "plot-viz-lib-size-1",
#| fig.width = 8,
#| fig.height = 4,
#| fig.cap = "Library size distribution."
library(ggplot2)
...
```{r}
#| label = "plot-viz-lib-size-2",
#| fig.width = 8,
#| fig.height = 4,
#| fig.cap = "Library sizes per sample."
library(ggplot2)
...
```{r}
#| label = "plot-viz-lib-size-3",
#| fig.width = 8,
#| fig.height = 4,
#| fig.cap = "Library sizes per sample type."
...
```{r}
taxa.abund.cc1 <- tse[, "CC1"]
taxa.abund.cc1[1:10]
```

For a selected assay:

```{r}
taxa.abund.cc1 <- assay(tse, assay.type="counts")[, "CC1"]
taxa.abund.cc1[1:10]
```

### Abundances of specific feature in all samples   

```{r}
taxa.abundances <- tse["Phylum:Bacteroidetes",]
...
```{r}
taxa.abundances <- assay(tse, assay.type="counts")["Phylum:Bacteroidetes",]
taxa.abundances[1:10]
```
...
```{r}
#| label = "plot-div-shannon",
#| message = FALSE,
#| fig.cap = "Shannon diversity estimates plotted grouped by sample type with colour-labeled barcode."
library(scater)
plotColData(tse, 
            "observed", 
            "SampleType", 
...
```{r}
#| label = "plot-mds-nmds-comparison",
#| fig.cap = "Comparison of MDS and NMDS plots based on the Bray-Curtis or euclidean distances on the GlobalPattern
#| dataset.",
#| message = FALSE
...
```{r}
#| label = "plot-tsne",
#| fig.cap = "t-SNE plot on the GlobalPatterns data set containing sample from different sources."
...
```{r}
#| label = "cross-correlation3"
# Metabolite data
mae[[2]]
```

```{r}
#| label = "cross-correlation4"
# Biomarker data
mae[[3]]
```
...
Useful functions: [taxonomyRanks](https://microbiome.github.io/mia/reference/taxonomy-methods.html), mergeFeaturesByRank, mergeFeatures
...
Useful functions: estimateDiversity, colSums, mergeFeaturesByRank, kruskal.test, cor
...
Useful functions: pheatmap, ComplexHeatMap::Heatmap, ggplot, transformAssay, testExperimentCrossAssociation
