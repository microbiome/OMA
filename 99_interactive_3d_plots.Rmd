...
```{r load data}
execution_times <- read_excel("data/execution_times.xlsx")
```

```{r prepare data}
execution_times <- execution_times %>% filter(!is.na(samples)) %>% mutate(samples_by_features = samples * features) 
```

### Execution time as a function of sample number

```{r compare melting}
ggplot(execution_times, aes(x = samples, y = melt, color = melt_command)) + 
  geom_point() +
  labs(title = "Melting comparison", x = "Number of samples", y = "Execution time in s", color = "melt command") +
  theme_classic() +
...
ggplot(execution_times, aes(x = samples, y = transform, color = transform_command)) + 
  geom_point() +
  labs(title = "Transformation comparison", x = "Number of samples", y = "Execution time in s", color = "transform command") +
  theme_classic() +
  theme(legend.position = "bottom")
```

```{r compare agglomerate}
ggplot(execution_times, aes(x = samples, y = agglomerate, color = agglomerate_command)) + 
  geom_point() +
  labs(title = "Agglomeration comparison", x = "Number of samples", y = "Execution time in s", color = "agglomerate method") +
  theme_classic() +
  theme(legend.position = "bottom")
```

### Execution time as a function of samples * features

```{r compare melting}
ggplot(execution_times, aes(x = samples_by_features, y = melt, color = melt_command)) + 
  geom_point() +
  labs(title = "Melting comparison", x = "Samples * Features", y = "Execution time in s", color = "melt command") +
  theme_classic() +
  theme(legend.position = "bottom")
```

```{r compare transform}
ggplot(execution_times, aes(x = samples_by_features, y = transform, color = transform_command)) + 
  geom_point() +
  labs(title = "Transformation comparison", x = "Samples * Features", y = "Execution time in s", color = "transform command") +
  theme_classic() +
  theme(legend.position = "bottom")
```

```{r compare agglomerate}
ggplot(execution_times, aes(x = samples_by_features, y = agglomerate, color = agglomerate_command)) + 
  geom_point() +
  labs(title = "Agglomeration comparison", x = "Samples * Features", y = "Execution time in s", color = "agglomerate method") +
  theme_classic() +
  theme(legend.position = "bottom")
