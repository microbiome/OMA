...
We use the [MOFA2](https://www.bioconductor.org/packages/release/bioc/html/MOFA2.html) package for analysis.
It can be installed with `BiocManager::install()` if you have not done so already.
