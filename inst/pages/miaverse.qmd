...
- [CBEA](https://github.com/qpmnguyen/CBEA/) [@Nguyen2022] for taxonomic enrichment analysis
- [microSTASIS](https://github.com/BiotechPedro/microSTASIS) [@Sanchez2022] for microbiota stability assessment via iterative clustering
- [PLSDAbatch](https://github.com/EvaYiwenWang/PLSDAbatch) [@Wang2023] for batch effect correction
- [treeclimbR](https://github.com/csoneson/treeclimbR) [@Hang2021] for finding optimal signal levels in a tree
- [dar](https://github.com/MicrobialGenomics-IrsicaixaOrg/dar) for differential abundance testing
- [iSEEtree](https://github.com/microbiome/iSEEtree) for interactive visualisation of microbiome data 
