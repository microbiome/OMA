...
containers utilized in [miaverse](https://microbiome.github.io/). [@sec-packages] details the packages
...
analysis
- `r BiocStyle::Biocpkg("HMP2Data")` [@HMP2data] for accessing Human Microbiome
Project 2 data
...
- `r BiocStyle::Biocpkg("MicrobiomeBenchmarkData")` [@Gamboa-Tuz2025] contains
datasets with known biological ground truth for benchmarking
