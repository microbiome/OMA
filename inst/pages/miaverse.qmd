...
- [maaslin](https://bioconductor.org/packages/devel/bioc/html/maaslin3.html) (@Nickols2024) for differential abundance analysis
...
- [mofa](https://www.bioconductor.org/packages/release/bioc/html/MOFA2.html) (@Arpelaguet2017) for multi-omics factor analysis
- [netcom](https://cran.r-project.org/web/packages/netcom/index.html) (@Langendorf2021) for network comparison inference.
