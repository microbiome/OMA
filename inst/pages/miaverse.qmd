...
- [miaDash](https://microbiome.github.io/miaDash/): Interactive analysis and visualisation [@R_miaDash]
...
- [iSEEtree](https://microbiome.github.io/iSEEtree/articles/iSEEtree.html) (@R_iSEEtree) for interactive visualisation of microbiome data 
...
## Interactive analysis {#sec-interactive}

We also provide the Microbiome Analysis Dashboard (miaDash), a web app to manipulate and visualise microbiome data. The app allows users to interactively use mia functionality without the need for programming knowledge. This way, beginner users can practice microbiome analysis and learn concepts without having the additional burden to code. While most operations can be performed, some are missing but the app can be easily extended (upon request if some useful missing things are noticed). The app is available online at [this address](https://miadash-microbiome.2.rahtiapp.fi/). Feature requests and bug reports can be submitted [here](https://github.com/microbiome/miaDash/issues/).
