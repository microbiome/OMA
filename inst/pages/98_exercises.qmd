...
2. Import data from another format using Mia. (functions: loadFromMetaphlan | loadFromMothur | loadFromQIIME2 | makeTreeSummarizedExperimentFromBiom | makeTreeSummarizedExperimentFromDADA2 ...)  
...
Useful functions from mia: getPrevalence, getPrevalentFeatures, subsetByPrevalentFeatures
...
Useful functions: wilcox.test, kruskal.test, ggplot, ComplexHeatMap::pheatmap, ComplexHeatMap::Heatmap, ancombc, aldex2, maaslin2, mergeFeaturesByRank, transformAssay, subsetByPrevalentFeatures
