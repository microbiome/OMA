...
# Generate sample abundance data
set.seed(123)
sample_data <- matrix(rnorm(100), nrow = 10)
rownames(sample_data) <- paste0("Gene", 1:10)
colnames(sample_data) <- paste0("Sample", 1:10)

# Perform hierarchical clustering
hclust_result <- hclust(dist(t(sample_data)), method = "complete")

# Assign cluster information to metadata
clusters <- cutree(hclust_result, k = 3)
metadata <- data.frame(Cluster = as.factor(clusters))
rownames(metadata) <- colnames(sample_data)
