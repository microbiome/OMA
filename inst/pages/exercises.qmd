...
Further, let's explore a continuous covariate, "coverage". 'Coverage' is a measure
of how comprehensively the microbial diversity was sampled in each sample. This
could refer to the sequencing depth (number of reads) or an index like Good’s 
Coverage that quantifies the completeness of sampling.
