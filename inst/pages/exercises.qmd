...
4. Visualize the relative abundances with a heatmap using the `sechm` package.
...
5. Create a similar heatmap but now using the `ComplexHeatmap` package directly.
...
1. Create an interactive heatmap in Phylum level. Visualize standardized
(Z-scored) relative abundances.

```{r}
#| label: extra-interactiveheatmap-ex1
#| code-fold: true
#| code-summary: "Show solution"
#| eval: false
...
2. k-means clustering on reduced dimensions and visualization
...
```{r}
#| label: extra-kmeansclustering-heatmap-ex2
#| eval: FALSE
#| code-fold: true
#| code-summary: "Show solution"
...
```{r}
#| label: extra-hierarchialclustering-heatmap-ex3
#| eval: FALSE
#| code-fold: true
#| code-summary: "Show solution"
...
4. In the previous heatmap, order the columns based on clusters.

```{r}
#| label: extra-customcolorheatmap-ex-4
#| code-fold: true
#| code-summary: "Show solution"
#| eval: false
