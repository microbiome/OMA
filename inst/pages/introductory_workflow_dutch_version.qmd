...
de Bray-curtis dimensies op een lagere ruimte met behoud van zoveel mogelijk variatie. De geprojecteerde waarden worden principale coördinaten genoemd. U kunt hier @Multidimensional-scaling meer
lezen over dit type analyse.
...
**dit gedeelte**[@sec-multi-assay-analyses].
