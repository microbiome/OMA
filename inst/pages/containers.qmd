...
4. Retrieve the available assay. Briefly explore the data. Can you
...
3. List the available columns stored in feature metadata or the taxonomy table.

4. Now do the same for the rows of `rowData`. What do these names correspond to?
