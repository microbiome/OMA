...
![Bioconductor logo.](images/bioconductor_logo.jpg){width="40%"}

Central to the software in Bioconductor are data containers, which provide a
structured presentation of data. Biological data is often complex and
...
![Data containers are central in Bioconductor.](images/ecosystem.png){width="50%"}
...
![Optimal data container.](images/optimal_data_container.png){width="50%"}
...
`TreeSummarizedExperiment` data container [@sec-miaverse].
...
concept in microbiome research, this book, particularly the [@training] section,
