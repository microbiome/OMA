...
_phyloseq_ object  (Bonus: Handoff to phyloseq). To store the data to _TreeSE_,
...
_cobiclust_ is especially developed for microbiome data whereas _biclust_ is
...
_cobiclust_ takes counts table as an input and gives _cobiclust_ object as an
...
Here, we analyze cross-association between taxa and metabolites. This
