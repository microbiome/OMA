...
### Further information on some other DAA tools :

### LinDA 

One more tool is LinDA which covers linear models for differential abundance analysis of
microbiome compositional data (@Zhou2022). This is very similar to
ANCOMBC with few differences: 
  1) LinDA corrects for the compositional
bias differently using the mode of all regression coefficients. 
...
Nevertheless, LinDA seems a promising
...
Subsequently, we can also demonstrate DAA with ZicoSeq, a method based on linear models
