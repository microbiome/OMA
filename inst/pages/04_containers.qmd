...
Further more, to illustrate the use of multiple assays, the relative abundance data can be 
...
This taxonomic information is extremely important for understanding the composition and diversity of the microbiome in each sample analyzed. It enables you to identify the different types of micro-organisms present in samples, and to explore the relationships between microbiome composition and various environmental or health factors.
