# Tools for microbiome analysis {#sec-tool_list}
...
HMP2Data [16S rRNA sequencing data from the Human Microbiome Project 2](https://bioconductor.org/packages/HMP2Data)   
HoloFoodR [R interface to EBI HoloFood resource](https://bioconductor.org/packages/HoloFoodR)   
...
MGnifyR [R interface to EBI MGnify metagenomics resource](https://bioconductor.org/packages/MGnifyR)   
microbiome R package  [Tools for microbiome analysis in R](https://github.com/microbiome/microbiome)    
MicrobiomeBenchmarkData [Datasets for benchmarking in microbiome research](https://bioconductor.org/packages/MicrobiomeBenchmarkData)   
