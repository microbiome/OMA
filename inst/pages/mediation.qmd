...
#|   mediation. A. The effect of x on y is completely mediated by m. B. The
#|   effect of x on y is direct, and only a portion thereof is mediated by m.
#| message: false
#| echo: false
...
specified with the arguments `treatment`, `outcome` and `mediator`,
respectively. We control for sex and age and limit comparisons to two
nationality groups, Central Europeans (control) vs. Scandinavians (treatment).
...
might imply that mediation emerges from their joint contribution.
