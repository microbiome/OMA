...
3. Agglomerate data to most prevalent genera.

4. Apply CLR transformation.

5. Perform mediation analysis. Analyse genera as a mediators of treatment effect.

6. Observe the results. Is there any taxa that have significant causal effect 
(ACME)?
...
`agglomerateByPrevalence`, `transformAssay()`, `addMediation()`,
`plotMediation()`
