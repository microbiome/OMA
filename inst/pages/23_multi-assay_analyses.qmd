...
duplicates are present. We can add `rownames(mae[[1]]) <- getTaxonomyLabels(mae[[1]], make.unique=TRUE)` to remove them.
...
# Transforming biomarker data with standardize-transform
