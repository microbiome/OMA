...
[@sec-containers]. Another experiment can be stored in _altExp_ slot
of SE data container. Alternatively, both experiments can be stored
side-by-side in a MAE data container (see sections [@sec-alt-exp] and [@sec-mae]
...
correlations <- getCrossCorrelation(mae, 
                                    experiment1 = 1,
                                    experiment2 = 2,
                                    assay.type1 = "log10", 
                                    assay.type2 = "nmr",
