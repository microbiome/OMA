...
::: {#translate}
<a href="Introductory-workflow-french-version.qmd"><img src="images/flags/France_flag.png" alt="French flag" class="flag"/> **French** </a> <a href="Introductory-workflow-dutch-version.qmd"><img src="images/flags/Netherland_flag.jpg" alt="Netherland flag" class="flag"/> **Dutch** </a>
:::
...
$$ Luckily for us, the [**mia package**](https://microbiome.github.io/mia/) provides an easy way to calculate the relative abundance for our TreeSE using the `transformAssay` method.
...
This will take the original counts assay and calculate the relative abundances. The result is a matrix with the sample identifiers as rows and the relative abundances for each taxon within those samples as columns. It can be accessed in the assays of the tse:
