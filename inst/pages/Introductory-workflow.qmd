...
# Datavisualization using heatmaps
...
Then, let's subset the TreeSE to the most prevalent taxa:
...
tse.subset <- transformAssay(tse.subset, assay.type = "counts", 
                             method = "relabundance")
...
sechm(tse.subset, features = rownames(rowData(tse.subset)),
