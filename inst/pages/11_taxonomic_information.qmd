 ...
 * 'standardize' standardize transformation scales data to zero mean 
   and unit variance; this is used to bring features (or samples) to 
   more comparable levels in terms of mean and scale of the values. 
   This can enhance visualization and interpretation of the data
