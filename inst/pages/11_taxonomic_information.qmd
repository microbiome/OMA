...
filtering them out. A suitable function for this is `agglomerateByRank`.
The number of rare taxa is higher on the species level, which causes the need 
for data agglomeration by prevalence.

```{r}
altExp(tse, "Species_byPrevalence") <- agglomerateByRank(tse, 
                                                               rank = "Species", 
                                                               other.label = "Other", 
                                                               prevalence = 5 / 100, 
                                                               detection = 1 / 100, 
...
tse <- transformAssay(tse, assay.type = "clr", method = "standardize", 
                      MARGIN = "rows")

# Cluster (with euclidean distance) on the features of the `standardize` assay
tse <- addCluster(tse,
