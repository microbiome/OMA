...
include_graphics("DAA_example/figures/summary_plot.png")
```
...
5. Explore the results table. Is there any taxa with significant abundance difference?

6. Print the default plot from Maaslin3.

7. Run the same analysis now with confounders. Do the results differ? Why?

8. Select the significant taxa and visualize their abundance with a violin plot.

Useful functions:

`colData`, `subsetByPrevalent()`, `maaslin3::maaslin3()`, `include_graphics()`,
`plotExpression()`
