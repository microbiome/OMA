...
multiple methods to verify if the findings are consistent across different approaches.
...
variables such as patient status and cohort, the statistics indicate whether the abundance
