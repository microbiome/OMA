...
found at the top or bottom. We will use the R package `r BiocStyle::CRANpkg("gsEasy")`
to conduct the MSEA test described by @Subramanian2005.
...
from `MaAsLin2`. We use the `r BiocStyle::Biocpkg("topGO")` package to create
a list of microbe sets from the mapping file created above.
...
default settings and construct the modules using residuals from the `MaAsLin2`
models.
