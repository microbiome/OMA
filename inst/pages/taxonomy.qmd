...
The columns containing the taxonomic information must be named domain, kingdom, 
phylum, class, order, family, genus, species or with a capital first letter.
...
We also have support for "superkingdom", and "strain" ranks
:::
