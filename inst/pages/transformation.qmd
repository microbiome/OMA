...
## Statistical challenges of microbiome data {#sec-stat-challenges}
 ...
 * 'standardize' Standardize(or 'z-score') transformation scales data to zero mean and 
   unit variance. This is used to bring features (or samples) to more 
...
Add here info on pseudocount, and cite paper that tells the choice of pseudocount
ccan affetc the result.
...
You can find more information on normalization from [OSCA book](https://bioconductor.org/books/3.18/OSCA.basic/normalization.html#normalization-transformation).
