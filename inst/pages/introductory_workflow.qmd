...
(Attention Deficit Hyperactivity Disorder) to controls. Let's load this dataset
...
For a recap on the structure of common data containers, see [@sec-containers].
...
and differences between samples in a simplified manner.
