...
p1 <- scater::plotReducedDim(tse2, "MDS_BC",
    colour_by = "CST", point_alpha = 1,
    percentVar = var[c(1, 2)] * 100
) + th + labs(title = "Ordination by Cluster") +
    theme(plot.title = element_text(hjust = 0.5))
# plot MDS with Bray-Curtis dimensions 3 and 4
p2 <- scater::plotReducedDim(tse2, "MDS_BC",
    colour_by = "CST", point_alpha = 1,
    ncomponents = c(3, 4), percentVar = var[c(1, 2, 3, 4)] * 100
) + th
# show results
...
dmn_group <- calculateDMNgroup(tse_dmn,
    variable = "Country", assay.type = "counts",
...
# Creates a plot
bray_dmm_plot <- ggplot(
    data = bray_dmm_pcoa_df,
...
```{r}
# CLR and standardize transforms
tse_dmn <- transformAssay(tse_dmn,
    MARGIN = "cols",
