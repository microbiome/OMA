...
tse_phylum <- transformAssay(
    tse_phylum,
    MARGIN = "cols", method = "clr", assay.type = "counts",
    pseudocount = 1
)
...
tse_Genus <- addMDS(
    ...
    name = "MDS_bray"
) # name of the PCoA within the tse
