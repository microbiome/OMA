...
### Calculating alpha diversity: estimate_richness = addAlpha(x, assay.type, index = "shannon")
...
The mia command addAlpha will return a TreeSE and the results are stored in colData, unlike the phyloseq command that outputs a data frame with just the diversity estimates.
...
tse <- addAlpha(tse, assay.type = "counts", index = "shannon") # Let's use counts
