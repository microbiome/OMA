...
- *Leo Lahti, DSc*, professor in Data Science in the [Department of
   ...
   He is a current member in the [Bioconductor Community Advisory
...
To contribute to the project, please follow the Git flow procedure introduced below. See instructions
to [get started with Github](https://docs.github.com/en/get-started)):
