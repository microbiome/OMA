...
```{r plot-pca, fig.cap = "PCA plot on the GlobalPatterns data set containing samples from different sources."}
# Run PCA
tse <- runPCA(
    tse,
    name = "PCA",
...
```{r plot-umap, fig.cap = "UMAP plot on the GlobalPatterns data set containing samples from different sources."}
# Run UMAP
tse <- runUMAP(
    tse,
    name = "UMAP",
