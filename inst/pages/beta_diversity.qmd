...
To address uneven sequencing effort, rarefaction aims to normalize metagenomic reads
...
and if the rarefaction depth is set to the lowest metagenomic reads count found across all samples, no data will be omitted. 
