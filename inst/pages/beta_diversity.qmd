...
**Goal:** The goal of these exercises is to get insights on the community and its relation to
sample groups.
...
5. Retrieve PCA results from `reducedDim` slot, and explore them. Where are the
principal components located? How about feature loadings and eigenvalues?
...
strongest associations? Interpret these results in relation to sample grouping.
Is there associations between the abundance of certain features and sample variables?
...
have homogeneous variance? Is there a significant association between variables
