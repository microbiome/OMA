...
tse2 <- transformAssay(tse2, MARGIN = "samples", assay.type = "counts",
                        method = "clr", pseudocount=1)
tse2 <- transformAssay(tse2, MARGIN = "features", assay.type = "clr", method = "standardize")
# get top taxa
tse2 <- tse2[is.element(rownames(tse2), rel_taxa), ]

mat <- assays(tse2)$standardize
...
```{r}
# get clr + standardize-transformed counts
...
# get just counts
mat <- assays(tse_dmn)$standardize
