...
p1 <- scater::plotReducedDim(tse2, "MDS_BC", colour.by = "CST", point.alpha = 1, 
                             percentVar = var[c(1, 2)]*100) + th + labs(title = "Ordination by Cluster") +
                             theme(plot.title = element_text(hjust = 0.5))
# plot MDS with Bray-Curtis dimensions 3 and 4
p2 <- scater::plotReducedDim(tse2, "MDS_BC", colour.by = "CST", point.alpha = 1, 
...
scater::plotReducedDim(tse2, "NMDS_BC", colour.by = "CST", point.alpha = 1) + th + 
