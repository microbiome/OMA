...
described based on taxa characteristics, representing each community. The samples are described 
...
clusters based on the dissimilarity matrix. The data can be clustered either based on features or samples. The examples below 
...
The cluster information is added in the metadata with an optional `name`. In this
