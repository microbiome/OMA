...
plotColData(tse, "shannon", colour.by = "SampleType")
```
...
plotReducedDim(tse, "NMDS", colour.by = "shannon")
```
...
plotReducedDim(tse, "MDS", ncomponents = c(1:3), colour.by = "faith")
```
...
tse_phylum <- transformAssay(tse_phylum, MARGIN = "cols", method = "clr", assay.type = "counts", pseudocount=1)
