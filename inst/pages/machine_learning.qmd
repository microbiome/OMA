...
it's common for the abundance of two or more taxa to be highly correlated.
Thus, removing or collapsing correlated taxa allows the
...
feature (i.e., bacterial taxa) is responsible of a complex clinical output 
of interest. However, more often than not, microbes interact with one 
another, and thus the effect of a single taxa doesn't always inform about
ecosystem-level properties of the microbiome. It is important to 
