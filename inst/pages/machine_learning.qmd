...
model to analyze them as one group.
...
roc_p <- roc_p +
    geom_abline(color = "gray30", linetype = "dashed")
...
prc_p <- prc_p +
    geom_hline(color = "gray30", linetype = "dashed", yintercept = 0.5)
...
obs_vs_pred <- obs_vs_pred + geom_abline(color = "gray30", linetype = "dashed")
