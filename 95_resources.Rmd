...
* [DNAString](https://rdrr.io/bioc/Biostrings/man/DNAString-class.html) along with `DNAStringSet`,`RNAString` and `RNAStringSet`  efficient storage and handling of long biological sequences are offered within the [@R-Biostrings] package.
 ...
 * Bioconductor Workflow for Microbiome Data Analysis: from raw reads to community analyses ([@callahan2016bioconductor]).
...
* How S4 Methods Work ([@chambers2006s4])

|   Books:

* John M. Chambers. Software for Data Analysis: Programming with R. Springer, New York, 2008. ISBN-13 978-0387759357. [@chambers2008software]
...
for data with hierarchical structure. F1000Research 9:1246. [@huang2020treesummarizedexperiment]
