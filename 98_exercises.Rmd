...
[this directory]() with the readily disassembled components of HintikkaXOData.
...
Great job! You performed a cross-correlation analysis between two experiments
of a MAE and visualized the results with a heatmap. You are also able to
customise the correlation method and significance testing used for the analysis.

#### Multi-omic Factor Analysis (MOFA)

We further move onto an exercise on MOFA.

* Move further onto multi-omics factor analysis (\@ref(mofa)).

Congratulations! You conducted a MOFA bla bla bla.
