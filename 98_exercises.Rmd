...
Explore and summarize peerj13075 data.

1. Please install the latest development version of mia from GitHub.
2. Load peerj13075 data from mia.
...
4. Summarize findigs by plotting a taxa vs samples heatmap. Add column annotation that tells the group of each sample, and row annotation that tells whether the difference of certain taxa was statistically significant.
...
1. Load HintikkaXOData from microbiomeDataSets.
