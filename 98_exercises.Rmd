...
1. Import the mia package, load one of the example data sets mentioned in Chapter 3.3
   with `data` (you need one with taxonomic information) with `data` and store it into a
   variable named `tse`.
...
1. Import the mia package, load load any of the example data sets mentioned in Chapter 3.3
   with `data` and store it into a variable named `tse`.
...
1. Import the mia and scater packages, load load any of the example data sets mentioned in Chapter 3.3
   with `data` and store it into a variable named `tse`.
...
1. Import the mia and vegan packages, load any of the example data sets mentioned in Chapter 3.3 with `data` and store it
   into a variable named `tse`.
