...
Extract some of the other TreeSE elements listed in chapter \@ref(containers).
...
1. Import the mia package, load one of the example data sets mentioned in Chapter 3.3
   (you need one with taxonomic information at Phylum level)
   and store it into a variable named `tse`.
...
1. Import the mia package, load one of the example data sets mentioned in Chapter 3.3
   (you need one with taxonomic information) and store it into 
   a variable named `tse`.
2. Check the taxonomic ranks of the features with `taxonomyRanks`. Can you find the same
   taxonomyRanks from `rowData` ? What is the deepest taxonomic rank available?
...
1. Import the mia package, load enterotype and store it into a
   variable named `tse`.
...
1. Import the mia and scater packages, load enterotype and store it
...
1. Import the mia package, load HintikkaXOData and store it into a
   variable named `mae`.
