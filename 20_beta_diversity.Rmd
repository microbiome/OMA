...
p <- plotReducedDim(tse, "MDS_BC", colour_by = "Group")
...
```{r}
anova(vegan::betadisper(attr(reducedDim(tse,"PCoA_BC"),"dist"),
                        colData(tse)$Group))
```

If the groups have similar dispersion, and PERMANOVA can be seen as an
