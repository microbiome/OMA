...
# Overview on the dominant taxa per sample
countDominantTaxa(tse_Genus, rank = "Genus")
```
...
# Naming all the rest of non top-taxa as "Other" representing the dominant taxa that are not included in the most abundant taxa in the data
