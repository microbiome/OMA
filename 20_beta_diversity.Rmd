...
We can perform PERMANVA with `adonis2` function or by first performing distance-based 
redundancy analysis (dbRDA), and then applying permutational test for result of 
redundancy analysis. Advantage ot hthe latter approach is that by doing so we can get 
