...
Some of the popular tools for DAA include:
...
maaslin2_out <- Maaslin2(t(assay(tse)),
...
# Store assay into a data.frame
feature.dat <- as.data.frame(assay(tse))
...
zicoseq.obj <- ZicoSeq(meta.dat, as.matrix(assay(tse)),
...
set.seed(123)
zicoseq.obj <- ZicoSeq(meta.dat = as.data.frame(colData(tse)) , 
