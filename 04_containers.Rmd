...
Result of shotgun sequencing is large number of files that include all the sequences
...
# Load objects
seqtab.nochim <- readRDS("data/dada2_seqtab.nochim.rds")
taxa <- readRDS("data/dada2_taxa.rds")
```
...
# Remove mock sample as it was removed also in tutorial
