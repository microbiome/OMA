...
ggplot(df, aes(padj)) +
  geom_histogram()
# Orders the rows of data frame in decreasing order based on column
# "log2FoldChange" and secondly based on "padj" column in ascending order
# then show the top 6 only.
...
# not suitable to be column names. This happened here with Escherichia/Shigella,
# which was change to Escherichia.Shigella by R. That caused some of the NA
# values where we expected p values or booleans (ANCOMBC output). Make sure to
# always inspect why you do not get the output you would have expected. Since
# Escherichia/Shigella was FALSE for all methods, I can easily work around this 
# by setting the NAs to FALSE.
