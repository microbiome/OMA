...
Here we use [NetCoMi](https://github.com/stefpeschel/NetCoMi) [@peschel2021netcomi] for network comparison, which includes the following **differential network analysis approaches:**
...
We also generate a network plot using phylum names to color the nodes and clr-transformed abundances for scaling node sizes.
