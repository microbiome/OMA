...
corr <- getExperimentCrossCorrelation(mae, 1, 2, 
                                      ...
                                      mode = "matrix", 
                                      cor_threshold = 0.2)
# Show first three correlations
corr[1:3, 1:3]
```

_biclust_ takes correlation matrix as an input and returns _biclust_ object. 
...
```{r biclust_6, fig.width=14, fig.height=6}
plot_list <- list()
