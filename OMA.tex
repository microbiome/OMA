...
\author{}
\date{\vspace{-2.5em}\textbf{Authors:} Leo Lahti {[}aut{]}, Sudarshan Shetty {[}aut{]}, Tuomas Borman {[}aut, cre{]}, Felix GM Ernst {[}aut{]} \textbf{Version:} 0.98.10 \textbf{Modified:} 2022-10-05 \textbf{Compiled:} 2023-01-11 \textbf{Environment:} R version 4.2.1 (2022-06-23), Bioconductor 3.15 \textbf{License:} CC BY-NC-SA 3.0 US \textbf{Copyright:} \textbf{Source:} \url{https://github.com/microbiome/OMA}}
