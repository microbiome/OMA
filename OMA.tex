...
\author{}
\date{\vspace{-2.5em}\textbf{Authors:} Leo Lahti {[}aut{]}, Sudarshan Shetty {[}aut{]}, Tuomas Borman {[}aut, cre{]}, Felix GM Ernst {[}aut{]} \textbf{Version:} 0.98.10 \textbf{Modified:} 2022-10-05 \textbf{Compiled:} 2022-11-09 \textbf{Environment:} R version 4.2.1 (2022-06-23), Bioconductor 3.15 \textbf{License:} CC BY-NC-SA 3.0 US \textbf{Copyright:} \textbf{Source:} \url{https://github.com/microbiome/OMA}}
...
\FunctionTok{colnames}\NormalTok{(out}\SpecialCharTok{$}\NormalTok{res}\SpecialCharTok{$}\NormalTok{diff\_abn)[}\FunctionTok{colnames}\NormalTok{(out}\SpecialCharTok{$}\NormalTok{res}\SpecialCharTok{$}\NormalTok{diff\_abn) }\SpecialCharTok{==} \StringTok{"taxon"}\NormalTok{] }\OtherTok{\textless{}{-}} \StringTok{"genus"}
...
\NormalTok{    out}\SpecialCharTok{$}\NormalTok{res}\SpecialCharTok{$}\NormalTok{diff\_abn }\SpecialCharTok{\%\textgreater{}\%}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Add random age variable for demonstration}
\FunctionTok{colData}\NormalTok{(tse)}\SpecialCharTok{$}\NormalTok{age }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(}\DecValTok{18}\SpecialCharTok{:}\DecValTok{64}\NormalTok{, }\FunctionTok{ncol}\NormalTok{(tse), }\AttributeTok{replace =} \ConstantTok{TRUE}\NormalTok{)}
...
\includegraphics{30_differential_abundance_files/figure-latex/unnamed-chunk-27-1.pdf}
...
\tightlist
\item
  Create a Quarto file (e.g.~Rstudio has ready-made templates for this).
\item
...
\item
  Update HTML file from the qmd file.
\end{enumerate}
