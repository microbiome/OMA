...
\item
  ...
  samples is stored in the \texttt{rowData} of the MAE
\item
...
\item
  ...
  desired assay
\item
  \textbf{Extra}: Repeat step 1 - 4 also for the microbiota and biomarkers experiments,
