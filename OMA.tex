...
\section{Other ordination methods}\label{other-ord-methods}}
...
\item
  \textbf{Extra}: Split the data based on other features (\texttt{splitOn})
\end{enumerate}
