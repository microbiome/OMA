...
\NormalTok{plots }\OtherTok{\textless{}{-}} \FunctionTok{pmap}\NormalTok{(}\FunctionTok{select}\NormalTok{(summ, taxid, score), }\ControlFlowTok{function}\NormalTok{(taxid, score) \{}
  \FunctionTok{ggplot}\NormalTok{(plot\_data, }\FunctionTok{aes\_string}\NormalTok{(}\StringTok{"Geographical\_location"}\NormalTok{, taxid)) }\SpecialCharTok{+}
