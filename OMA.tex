...
\author{}
\date{\vspace{-2.5em}\textbf{Authors:} Leo Lahti {[}aut{]}, Tuomas Borman {[}aut, cre{]}, Felix GM Ernst {[}aut{]}, and others (see the full list of contributors) {[}ctb{]} \textbf{Version:} 0.98.16 \textbf{Modified:} 2023-07-29 \textbf{Compiled:} 2023-08-23 \textbf{Environment:} R version 4.3.0 (2023-04-21), Bioconductor 3.17 \textbf{License:} CC BY-NC-SA 3.0 US \textbf{Copyright:} \textbf{Source:} \url{https://github.com/microbiome/OMA}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rda\_info}\SpecialCharTok{$}\NormalTok{permanova}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rda\_info}\SpecialCharTok{$}\NormalTok{homogeneity}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{rda }\OtherTok{\textless{}{-}} \FunctionTok{attr}\NormalTok{(}\FunctionTok{reducedDim}\NormalTok{(tse2, }\StringTok{"RDA"}\NormalTok{), }\StringTok{"rda"}\NormalTok{)}
...
\NormalTok{coldata }\OtherTok{\textless{}{-}} \FunctionTok{colData}\NormalTok{(tse2)[ }\FunctionTok{rownames}\NormalTok{(rda}\SpecialCharTok{$}\NormalTok{CCA}\SpecialCharTok{$}\NormalTok{wa), ]}
...
\NormalTok{    new\_name }\OtherTok{\textless{}{-}} \FunctionTok{expr}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\SpecialCharTok{!!}\NormalTok{new\_name, }\StringTok{" ("}\NormalTok{, }
                           \SpecialCharTok{!!}\FunctionTok{format}\NormalTok{(}\FunctionTok{round}\NormalTok{( rda\_info}\SpecialCharTok{$}\NormalTok{permanova[variable\_name, }\StringTok{"Explained variance"}\NormalTok{]}\SpecialCharTok{*}\DecValTok{100}\NormalTok{, }\DecValTok{1}\NormalTok{), }\AttributeTok{nsmall =} \DecValTok{1}\NormalTok{), }
                           \StringTok{"\%, "}\NormalTok{,}\FunctionTok{italic}\NormalTok{(}\StringTok{"P"}\NormalTok{), }\StringTok{" = "}\NormalTok{, }
                           \SpecialCharTok{!!}\FunctionTok{gsub}\NormalTok{(}\StringTok{"0}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{."}\NormalTok{,}\StringTok{"}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{."}\NormalTok{, }\FunctionTok{format}\NormalTok{(}\FunctionTok{round}\NormalTok{( rda\_info}\SpecialCharTok{$}\NormalTok{permanova[variable\_name, }\StringTok{"Pr(\textgreater{}F)"}\NormalTok{], }\DecValTok{3}\NormalTok{), }
...
\NormalTok{tse }\OtherTok{\textless{}{-}} \FunctionTok{cluster}\NormalTok{(tse, }\AttributeTok{assay.type =} \StringTok{"relabundance"}\NormalTok{, }
               \AttributeTok{MARGIN =} \StringTok{"samples"}\NormalTok{, }\FunctionTok{HclustParam}\NormalTok{())}

\CommentTok{\# Check the result contained in the clusters part of colData}
\FunctionTok{colData}\NormalTok{(tse)}\SpecialCharTok{$}\NormalTok{clusters}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{hclust\_data }\OtherTok{\textless{}{-}} \FunctionTok{metadata}\NormalTok{(tse)}\SpecialCharTok{$}\NormalTok{clusters}\SpecialCharTok{$}\NormalTok{hclust}
...
\FunctionTok{head}\NormalTok{(}\FunctionTok{colData}\NormalTok{(tse)}\SpecialCharTok{$}\NormalTok{Hclust)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{diss }\OtherTok{\textless{}{-}} \FunctionTok{metadata}\NormalTok{(tse)}\SpecialCharTok{$}\NormalTok{clusters}\SpecialCharTok{$}\NormalTok{dist}
...
\CommentTok{\# Perform k{-}means clustering with 2 clusters}
\NormalTok{km }\OtherTok{\textless{}{-}} \FunctionTok{kmeans}\NormalTok{(diss, }\DecValTok{2}\NormalTok{, }\AttributeTok{nstart =} \DecValTok{25}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{metadata}\NormalTok{(tse\_dmm)}\SpecialCharTok{$}\NormalTok{DMM}\SpecialCharTok{$}\NormalTok{dmm}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{24_clustering_files/figure-latex/dmm5-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Get the model that has the best fit}
\NormalTok{bestFit }\OtherTok{\textless{}{-}} \FunctionTok{metadata}\NormalTok{(tse\_dmm)}\SpecialCharTok{$}\NormalTok{DMM}\SpecialCharTok{$}\NormalTok{dmm[[}\FunctionTok{metadata}\NormalTok{(tse\_dmm)}\SpecialCharTok{$}\NormalTok{DMM}\SpecialCharTok{$}\NormalTok{best]]}
\NormalTok{bestFit}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dmm\_group }\OtherTok{\textless{}{-}} \FunctionTok{calculateDMNgroup}\NormalTok{(tse\_dmm, }\AttributeTok{variable =} \StringTok{"SampleType"}\NormalTok{, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{prob }\OtherTok{\textless{}{-}} \FunctionTok{metadata}\NormalTok{(tse\_dmm)}\SpecialCharTok{$}\NormalTok{DMM}\SpecialCharTok{$}\NormalTok{prob}
\FunctionTok{head}\NormalTok{(prob)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{euclidean\_dmm\_pcoa\_df }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(euclidean\_pcoa\_df,}
                               \AttributeTok{dmm\_component =} \FunctionTok{colData}\NormalTok{(tse\_dmm)}\SpecialCharTok{$}\NormalTok{clusters)}
...
\includegraphics{24_clustering_files/figure-latex/dmm11-1.pdf}

\hypertarget{graph-based-clustering}{%
\section{Graph-based clustering}\label{graph-based-clustering}}
...
Here, we will be using the \texttt{cluster} function with a graph-based clustering
function, enabling the community detection task.

The algorithm used is ``short random walks'' \citep{Pons2006}. The graph is
...
\CommentTok{\# Set different k values to test}
...
\NormalTok{ClustAndPlot }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(x) \{}
    \CommentTok{\# Add the clustering data from the short random walks algorithm to the TSE}
\NormalTok{    tse }\OtherTok{\textless{}{-}} \FunctionTok{cluster}\NormalTok{(tse, }\AttributeTok{assay.type =} \StringTok{"rclr"}\NormalTok{, }
                   \AttributeTok{MARGIN =} \StringTok{"col"}\NormalTok{, }\FunctionTok{NNGraphParam}\NormalTok{(}\AttributeTok{k =}\NormalTok{ x))}
    
    \CommentTok{\# Plot the results of the clustering as a color for each sample}
    \FunctionTok{plotUMAP}\NormalTok{(tse, }\AttributeTok{colour\_by =} \FunctionTok{I}\NormalTok{(}\FunctionTok{colData}\NormalTok{(tse)}\SpecialCharTok{$}\NormalTok{clusters)) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \FunctionTok{paste0}\NormalTok{(}\StringTok{"k = "}\NormalTok{, x))}
\NormalTok{\}}

\CommentTok{\# Apply the function for different k values}
\NormalTok{plots }\OtherTok{\textless{}{-}} \FunctionTok{lapply}\NormalTok{(k, ClustAndPlot)}

\CommentTok{\# Display plots in a grid}
\NormalTok{plots[[}\DecValTok{1}\NormalTok{]] }\SpecialCharTok{+}\NormalTok{ plots[[}\DecValTok{2}\NormalTok{]] }\SpecialCharTok{+}\NormalTok{ plots[[}\DecValTok{3}\NormalTok{]] }\SpecialCharTok{+}\NormalTok{ plots[[}\DecValTok{4}\NormalTok{]] }\SpecialCharTok{+} \FunctionTok{plot\_layout}\NormalTok{(}\AttributeTok{ncol =} \DecValTok{4}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{24_clustering_files/figure-latex/NNGraph1-1.pdf}
...
\NormalTok{ClustDiagPlot }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(x) \{}
  \CommentTok{\# Get the clustering results}
\NormalTok{    tse }\OtherTok{\textless{}{-}} \FunctionTok{cluster}\NormalTok{(tse, }\AttributeTok{assay.type =} \StringTok{"rclr"}\NormalTok{, }
                   \AttributeTok{MARGIN =} \StringTok{"col"}\NormalTok{, }\FunctionTok{NNGraphParam}\NormalTok{(}\AttributeTok{k =}\NormalTok{ x))}

    \CommentTok{\# Compute the diagnostic info}
\NormalTok{    sil }\OtherTok{\textless{}{-}} \FunctionTok{approxSilhouette}\NormalTok{(}\FunctionTok{t}\NormalTok{(}\FunctionTok{assays}\NormalTok{(tse)}\SpecialCharTok{$}\NormalTok{rclr), }\FunctionTok{colData}\NormalTok{(tse)}\SpecialCharTok{$}\NormalTok{clusters)}

    \CommentTok{\# Plot as a boxplot to observe cluster separation}
    \FunctionTok{boxplot}\NormalTok{(}\FunctionTok{split}\NormalTok{(sil}\SpecialCharTok{$}\NormalTok{width, }\FunctionTok{colData}\NormalTok{(tse)}\SpecialCharTok{$}\NormalTok{clusters), }\AttributeTok{main =} \FunctionTok{paste0}\NormalTok{(}\StringTok{"k = "}\NormalTok{, x))}
\NormalTok{\}}
\CommentTok{\# Apply the function for different k values}
...
\includegraphics{24_clustering_files/figure-latex/NNGraph2-1.pdf} \includegraphics{24_clustering_files/figure-latex/NNGraph2-2.pdf} \includegraphics{24_clustering_files/figure-latex/NNGraph2-3.pdf} \includegraphics{24_clustering_files/figure-latex/NNGraph2-4.pdf}
...
\NormalTok{tse }\OtherTok{\textless{}{-}} \FunctionTok{subsetByPrevalentTaxa}\NormalTok{(tse,}
                             \AttributeTok{rank =} \StringTok{"Genus"}\NormalTok{,}
...
\NormalTok{out }\OtherTok{\textless{}{-}} \FunctionTok{ancombc2}\NormalTok{(}\AttributeTok{data =}\NormalTok{ tse,}
...
\NormalTok{ancombc\_result }\OtherTok{\textless{}{-}} \FunctionTok{cbind.data.frame}\NormalTok{(}\AttributeTok{taxid =}\NormalTok{ out}\SpecialCharTok{$}\NormalTok{res}\SpecialCharTok{$}\NormalTok{taxon,}
                       \AttributeTok{ancombc =} \FunctionTok{as.vector}\NormalTok{(out}\SpecialCharTok{$}\NormalTok{res}\SpecialCharTok{$}\NormalTok{q\_patient\_statusControl))}

\NormalTok{ancombc\_result }\OtherTok{\textless{}{-}}\NormalTok{ out}\SpecialCharTok{$}\NormalTok{res }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{select}\NormalTok{(}\FunctionTok{starts\_with}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"taxon"}\NormalTok{, }\StringTok{"lfc"}\NormalTok{, }\StringTok{"q"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ancombc\_result }\SpecialCharTok{\%\textgreater{}\%}
...
\CommentTok{\# Store independent variables into a data.frame}
\NormalTok{meta.dat }\OtherTok{\textless{}{-}} \FunctionTok{colData}\NormalTok{(tse) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{as.data.frame}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{select}\NormalTok{(patient\_status)}

\CommentTok{\# Run LinDA}
\NormalTok{linda.res }\OtherTok{\textless{}{-}} \FunctionTok{linda}\NormalTok{(}\AttributeTok{feature.dat =} \FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{assay}\NormalTok{(tse)),}
                   \AttributeTok{meta.dat =}\NormalTok{ meta.dat,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{linda\_out }\OtherTok{\textless{}{-}}\NormalTok{ linda.res}\SpecialCharTok{$}\NormalTok{output}\SpecialCharTok{$}\NormalTok{patient\_statusControl}

\CommentTok{\# List genera for which H0 could be rejected:}
\NormalTok{linda\_out }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{as.data.frame}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
...
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}
\NormalTok{zicoseq.obj }\OtherTok{\textless{}{-}} \FunctionTok{ZicoSeq}\NormalTok{(}\AttributeTok{feature.dat =} \FunctionTok{as.matrix}\NormalTok{(}\FunctionTok{assay}\NormalTok{(tse)),}
...
\NormalTok{zicoseq\_out }\SpecialCharTok{\%\textgreater{}\%}
...
\NormalTok{ancombc\_cov }\OtherTok{\textless{}{-}} \FunctionTok{ancombc2}\NormalTok{(tse,}
                        \AttributeTok{assay\_name =} \StringTok{"counts"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ancombc\_cov}\SpecialCharTok{$}\NormalTok{res }\SpecialCharTok{\%\textgreater{}\%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{linda\_cov }\OtherTok{\textless{}{-}} \FunctionTok{linda}\NormalTok{(}\FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{assay}\NormalTok{(tse, }\StringTok{"counts"}\NormalTok{)),}
...
\NormalTok{linda.res }\OtherTok{\textless{}{-}}\NormalTok{ linda\_cov}\SpecialCharTok{$}\NormalTok{output}\SpecialCharTok{$}\NormalTok{patient\_statusControl}

\NormalTok{linda.res }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(reject) }\SpecialCharTok{\%\textgreater{}\%}
...
\subsection{Differential abundance analysis}\label{differential-abundance-analysis}}
