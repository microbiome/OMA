...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{source}\NormalTok{(}\StringTok{"https://github.com/microbiome/OMA/blob/master/install\_packages.R"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
is \texttt{mia}. This and other packages can be installed with the following
procedure.
...
Some of the R packages supporting the \emph{(Tree)SummarizedExperiment} or
\emph{MultiAssayExperiment} framework include the following. If you know
more tips on such packages, data sources, or other resources, kindly
\href{https://microbiome.github.io}{let us know} through the issues, pull
...
\hypertarget{data-ecosystem}{%
\section{Data ecosystem}\label{data-ecosystem}}
...
\NormalTok{out }\OtherTok{\textless{}{-}} \FunctionTok{ancombc2}\NormalTok{(}
  ...
  \AttributeTok{em\_control =} \FunctionTok{list}\NormalTok{(}\AttributeTok{tol =} \FloatTok{1e{-}5}\NormalTok{, }\AttributeTok{max\_iter =} \DecValTok{20}\NormalTok{), }\CommentTok{\# use max\_iter \textgreater{}= 100 on real data }
...
\FunctionTok{kable}\NormalTok{(}\FunctionTok{head}\NormalTok{(}\FunctionTok{filter}\NormalTok{(}\FunctionTok{as.data.frame}\NormalTok{(res}\SpecialCharTok{$}\NormalTok{output}\SpecialCharTok{$}\NormalTok{Geographical\_locationPune), reject)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# change genus names to otu ids for ancombc results to make it joinable with others}
\NormalTok{id\_switch }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{rowData}\NormalTok{(tse)) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{rownames\_to\_column}\NormalTok{(}\StringTok{"taxid"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{select}\NormalTok{(taxid, genus)}
\NormalTok{abc\_res }\OtherTok{\textless{}{-}} \FunctionTok{select}\NormalTok{(out}\SpecialCharTok{$}\NormalTok{res, }\AttributeTok{genus =}\NormalTok{ taxon, }\AttributeTok{ancombc =}\NormalTok{ diff\_Geographical\_locationPune) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{left\_join}\NormalTok{(id\_switch, }\AttributeTok{by =} \StringTok{"genus"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{select}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{genus)}

\CommentTok{\# join all results together}
\NormalTok{summ }\OtherTok{\textless{}{-}} \FunctionTok{full\_join}\NormalTok{(}
    \FunctionTok{rownames\_to\_column}\NormalTok{(aldex\_out, }\StringTok{"taxid"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
      \FunctionTok{select}\NormalTok{(taxid, }\AttributeTok{aldex2 =}\NormalTok{ wi.eBH),}
\NormalTok{    abc\_res,}
    \AttributeTok{by =} \StringTok{"taxid"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{full\_join}\NormalTok{(}
    \FunctionTok{select}\NormalTok{(fit\_data}\SpecialCharTok{$}\NormalTok{results, }\AttributeTok{taxid =}\NormalTok{ feature, }\AttributeTok{maaslin2 =}\NormalTok{ qval), }
    \AttributeTok{by =} \StringTok{"taxid"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{full\_join}\NormalTok{(}
      \FunctionTok{rownames\_to\_column}\NormalTok{(}\FunctionTok{as.data.frame}\NormalTok{(res}\SpecialCharTok{$}\NormalTok{output}\SpecialCharTok{$}\NormalTok{Geographical\_locationPune), }\StringTok{"taxid"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
        \FunctionTok{select}\NormalTok{(taxid, }\AttributeTok{LinDA =}\NormalTok{ reject), }
      \AttributeTok{by =} \StringTok{"taxid"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}
    ...
    \AttributeTok{ancombc =} \FunctionTok{ifelse}\NormalTok{(}\FunctionTok{is.na}\NormalTok{(ancombc), }\ConstantTok{FALSE}\NormalTok{, ancombc),}
...
\NormalTok{plots }\OtherTok{\textless{}{-}} \FunctionTok{pmap}\NormalTok{(}\FunctionTok{select}\NormalTok{(summ, taxid, score), }\ControlFlowTok{function}\NormalTok{(taxid, score) \{}
