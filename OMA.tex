...
\author{}
\date{\vspace{-2.5em}\textbf{Authors:} Leo Lahti {[}aut{]}, Sudarshan Shetty {[}aut{]}, Tuomas Borman {[}aut, cre{]}, Felix GM Ernst {[}aut{]} \textbf{Version:} 0.98.10 \textbf{Modified:} 2022-10-05 \textbf{Compiled:} 2022-10-05 \textbf{Environment:} R version 4.2.1 (2022-06-23), Bioconductor 3.15 \textbf{License:} CC BY-NC-SA 3.0 US \textbf{Copyright:} \textbf{Source:} \url{https://github.com/microbiome/OMA}}
...
\NormalTok{tune\_grid }\OtherTok{\textless{}{-}} \FunctionTok{expand.grid}\NormalTok{(}\AttributeTok{nrounds =} \FunctionTok{c}\NormalTok{(}\DecValTok{100}\NormalTok{, }\DecValTok{200}\NormalTok{),}
                         \AttributeTok{max\_depth =} \DecValTok{6}\NormalTok{,}
                         \AttributeTok{colsample\_bytree =} \FunctionTok{c}\NormalTok{(}\FloatTok{0.8}\NormalTok{, }\DecValTok{1}\NormalTok{),}
                         ...
                         \AttributeTok{min\_child\_weight =} \FunctionTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{, }\DecValTok{5}\NormalTok{),}
...
\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{if}\NormalTok{( }\SpecialCharTok{!}\FunctionTok{require}\NormalTok{(plotROC) )\{}
    \FunctionTok{install.packages}\NormalTok{(}\StringTok{"plotROC"}\NormalTok{)}
    \FunctionTok{library}\NormalTok{(plotROC)}
\NormalTok{\}}
\CommentTok{\# Convert diets forms into binary}
\NormalTok{model}\SpecialCharTok{$}\NormalTok{pred}\SpecialCharTok{$}\NormalTok{pred\_binary }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(model}\SpecialCharTok{$}\NormalTok{pred}\SpecialCharTok{$}\NormalTok{pred }\SpecialCharTok{==} \StringTok{"Mixed"}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)}
\NormalTok{model}\SpecialCharTok{$}\NormalTok{pred}\SpecialCharTok{$}\NormalTok{obs\_binary }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(model}\SpecialCharTok{$}\NormalTok{pred}\SpecialCharTok{$}\NormalTok{obs }\SpecialCharTok{==} \StringTok{"Mixed"}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)}

\CommentTok{\# Predictions}
\NormalTok{predictions }\OtherTok{\textless{}{-}}\NormalTok{ model}\SpecialCharTok{$}\NormalTok{pred}

\CommentTok{\# Plot roc plot}
\NormalTok{plot\_roc }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(predictions, }\FunctionTok{aes\_string}\NormalTok{(}\AttributeTok{m =} \StringTok{"pred\_binary"}\NormalTok{, }\AttributeTok{d =} \StringTok{"obs\_binary"}\NormalTok{)) }\SpecialCharTok{+} 
    \FunctionTok{geom\_roc}\NormalTok{(}\AttributeTok{labels =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{n.cuts =} \DecValTok{0}\NormalTok{)}

\CommentTok{\# Create additional aesthetics and calculate AUC}
\NormalTok{plot }\OtherTok{\textless{}{-}}\NormalTok{ plot\_roc }\SpecialCharTok{+} 
    \FunctionTok{style\_roc}\NormalTok{() }\SpecialCharTok{+} 
    \FunctionTok{geom\_text}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\FloatTok{0.5}\NormalTok{, }\AttributeTok{label =} \FunctionTok{paste0}\NormalTok{(}\StringTok{"AUC = "}\NormalTok{, }\FunctionTok{round}\NormalTok{(}\FunctionTok{calc\_auc}\NormalTok{(plot\_roc)}\SpecialCharTok{$}\NormalTok{AUC, }\DecValTok{3}\NormalTok{) ) )) }\SpecialCharTok{+}
    \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position=}\StringTok{"none"}\NormalTok{)}
\NormalTok{plot}
\end{Highlighting}
\end{Shaded}
