...
microbiome of rat models \citep{ijerph18084049}. The dataset is briefly presented in
...
\ControlFlowTok{if}\NormalTok{ (}\SpecialCharTok{!}\FunctionTok{require}\NormalTok{(bluster)) \{}
  \FunctionTok{install.packages}\NormalTok{(}\StringTok{"bluster"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{if}\NormalTok{ (}\SpecialCharTok{!}\FunctionTok{require}\NormalTok{(scran)) \{}
\NormalTok{  BiocManager}\SpecialCharTok{::}\FunctionTok{install}\NormalTok{(}\StringTok{"scran"}\NormalTok{)}
...
\item
  \href{https://microbiome.github.io/outreach/index.html}{miaverse presentations} and other \href{https://github.com/microbiome/outreach}{outreach}
\item
