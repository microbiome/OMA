...
\ControlFlowTok{if}\NormalTok{( }\SpecialCharTok{!}\FunctionTok{require}\NormalTok{(ggsignif) )\{}
  \FunctionTok{install.packages}\NormalTok{(}\StringTok{"ggsignif"}\NormalTok{)}
\NormalTok{\}}
\FunctionTok{library}\NormalTok{(ggplot2)}
\FunctionTok{library}\NormalTok{(patchwork)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dmn\_group }\OtherTok{\textless{}{-}} \FunctionTok{calculateDMNgroup}\NormalTok{(tse\_dmn, }\AttributeTok{variable =} \StringTok{"SampleType"}\NormalTok{,  }\AttributeTok{assay.type =} \StringTok{"counts"}\NormalTok{,}
...
\ControlFlowTok{if}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{require}\NormalTok{(ANCOMBC))\{}
...
\NormalTok{\}}
\ControlFlowTok{if}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{require}\NormalTok{(GUniFrac))\{}
  \FunctionTok{install.packages}\NormalTok{(}\StringTok{"GUniFrac"}\NormalTok{)}
...
\includegraphics{30_differential_abundance_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# make phyloseq object}
\NormalTok{otu }\OtherTok{\textless{}{-}} \FunctionTok{otu\_table}\NormalTok{(}\FunctionTok{assay}\NormalTok{(tse), }\AttributeTok{taxa\_are\_rows =}\NormalTok{ T)}
\NormalTok{taxa }\OtherTok{\textless{}{-}} \FunctionTok{tax\_table}\NormalTok{(}\FunctionTok{as.matrix}\NormalTok{(}\FunctionTok{rowData}\NormalTok{(tse)))}
\NormalTok{meta }\OtherTok{\textless{}{-}} \FunctionTok{sample\_data}\NormalTok{(}\FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{colData}\NormalTok{(tse)))}
\NormalTok{phy }\OtherTok{\textless{}{-}} \FunctionTok{phyloseq}\NormalTok{(otu,taxa,meta)}
\CommentTok{\# perform the analysis }
\NormalTok{out }\OtherTok{\textless{}{-}} \FunctionTok{ancombc}\NormalTok{(}
  \AttributeTok{phyloseq =}\NormalTok{ phy,}
  \AttributeTok{formula =} \StringTok{"Geographical\_location"}\NormalTok{, }
...
\NormalTok{ancombc\_out }\OtherTok{\textless{}{-}} \FunctionTok{cbind.data.frame}\NormalTok{(}\AttributeTok{taxid =}\NormalTok{ out}\SpecialCharTok{$}\NormalTok{res}\SpecialCharTok{$}\NormalTok{q\_val}\SpecialCharTok{$}\NormalTok{taxon, }\AttributeTok{ancombc =} \FunctionTok{as.vector}\NormalTok{(out}\SpecialCharTok{$}\NormalTok{res}\SpecialCharTok{$}\NormalTok{q\_val}\SpecialCharTok{$}\NormalTok{Geographical\_locationPune))}
\CommentTok{\# store the FDR adjusted results [test on v1.2.2] }
\CommentTok{\# ancombc\_out \textless{}{-} out$res$q\_val \%\textgreater{}\% rownames\_to\_column(\textquotesingle{}taxid\textquotesingle{}) \%\textgreater{}\% dplyr::rename(ancombc = 2)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{summ }\OtherTok{\textless{}{-}} \FunctionTok{full\_join}\NormalTok{(}\FunctionTok{rownames\_to\_column}\NormalTok{(aldex\_out, }\StringTok{"taxid"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{select}\NormalTok{(taxid, }\AttributeTok{aldex2 =}\NormalTok{ wi.eBH),}
\NormalTok{    ancombc\_out,}\AttributeTok{by =} \StringTok{"taxid"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{full\_join}\NormalTok{(}
\NormalTok{    dplyr}\SpecialCharTok{::}\FunctionTok{select}\NormalTok{(maaslin2\_out}\SpecialCharTok{$}\NormalTok{results, }\AttributeTok{taxid =}\NormalTok{ feature, }\AttributeTok{maaslin2 =}\NormalTok{ qval), }
    \AttributeTok{by =} \StringTok{"taxid"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{full\_join}\NormalTok{(linda\_out }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{rename}\NormalTok{(}\AttributeTok{LinDA=}\NormalTok{padj) }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{select}\NormalTok{(LinDA)}\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{rownames\_to\_column}\NormalTok{(}\StringTok{\textquotesingle{}taxid\textquotesingle{}}\NormalTok{) ) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{full\_join}\NormalTok{(zicoseq\_out }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ dplyr}\SpecialCharTok{::}\FunctionTok{select}\NormalTok{(p.adj.fdr) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{rename}\NormalTok{(}\AttributeTok{ZicoSeq =}\NormalTok{ p.adj.fdr) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{rownames\_to\_column}\NormalTok{(}\StringTok{\textquotesingle{}taxid\textquotesingle{}}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}
    \FunctionTok{across}\NormalTok{(}\FunctionTok{c}\NormalTok{(aldex2}\SpecialCharTok{:}\NormalTok{ ZicoSeq), }\SpecialCharTok{\textasciitilde{}}\NormalTok{ .x }\SpecialCharTok{\textless{}=} \FloatTok{0.05}\NormalTok{),}
    \CommentTok{\# the following line would be necessary without prevalence filtering }
    \CommentTok{\# as some methods output NA}
    \CommentTok{\#across({-}taxid, function(x) ifelse(is.na(x), FALSE, x)),}
    \AttributeTok{score =} \FunctionTok{rowSums}\NormalTok{(}\FunctionTok{across}\NormalTok{(}\FunctionTok{c}\NormalTok{(aldex2, ancombc, maaslin2, LinDA, ZicoSeq)))}
\NormalTok{  )}
...
\CommentTok{\# Add relative abundances and clr abundances}
\NormalTok{tse }\OtherTok{\textless{}{-}} \FunctionTok{transformCounts}\NormalTok{(tse, }\AttributeTok{method=}\StringTok{"relabundance"}\NormalTok{)}
...
\CommentTok{\# Subset to prevalent taxa (exclude rare taxa at 10 percent prevalence using 0 detection threshold):}
\CommentTok{\# do the subsetting based on the relative abundance assay}
\NormalTok{tse }\OtherTok{\textless{}{-}} \FunctionTok{subsetByPrevalentTaxa}\NormalTok{(tse, }\AttributeTok{detection =} \DecValTok{0}\NormalTok{, }\AttributeTok{prevalence =} \DecValTok{10}\SpecialCharTok{/}\DecValTok{100}\NormalTok{, }\AttributeTok{assay.type=}\StringTok{"relabundance"}\NormalTok{)}

\CommentTok{\# Subset to certain geolocations}
\NormalTok{tse }\OtherTok{\textless{}{-}}\NormalTok{ tse[ ,tse}\SpecialCharTok{$}\NormalTok{Geographical\_location }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"Pune"}\NormalTok{, }\StringTok{"Nashik"}\NormalTok{)]}

\CommentTok{\# Let us make the geo location a factor}
\NormalTok{tse}\SpecialCharTok{$}\NormalTok{Geographical\_location }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(tse}\SpecialCharTok{$}\NormalTok{Geographical\_location)}

\CommentTok{\# Create a jittered boxplot for each genus }
\NormalTok{assay.type }\OtherTok{\textless{}{-}} \StringTok{"relabundance"}
\NormalTok{plot\_data }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\FunctionTok{t}\NormalTok{(}\FunctionTok{assay}\NormalTok{(tse, assay.type)))}
...
\NormalTok{plots }\OtherTok{\textless{}{-}} \FunctionTok{pmap}\NormalTok{(dplyr}\SpecialCharTok{::}\FunctionTok{select}\NormalTok{(summ, taxid, score), }\ControlFlowTok{function}\NormalTok{(taxid, score) \{}
  \FunctionTok{ggplot}\NormalTok{(plot\_data, }\FunctionTok{aes\_string}\NormalTok{(}\AttributeTok{x=}\StringTok{"Geographical\_location"}\NormalTok{, }\AttributeTok{y=}\NormalTok{taxid)) }\SpecialCharTok{+}
    \FunctionTok{geom\_boxplot}\NormalTok{(}\AttributeTok{outlier.shape =} \ConstantTok{NA}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_jitter}\NormalTok{(}\AttributeTok{width =} \FloatTok{0.2}\NormalTok{) }\SpecialCharTok{+}
    \CommentTok{\# scale\_y\_log10() + \# log trans will cause 0 values missing }
    \FunctionTok{scale\_y\_sqrt}\NormalTok{() }\SpecialCharTok{+} 
    \FunctionTok{labs}\NormalTok{(}\AttributeTok{title=}\NormalTok{glue}\SpecialCharTok{::}\FunctionTok{glue}\NormalTok{(}\StringTok{"\{taxid\}"}\NormalTok{), }\AttributeTok{x=}\StringTok{""}\NormalTok{, }\AttributeTok{y=}\NormalTok{glue}\SpecialCharTok{::}\FunctionTok{glue}\NormalTok{(}\StringTok{"Abundance (\{assay.type\})"}\NormalTok{)) }\SpecialCharTok{+}    
    \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+}
    \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position =} \StringTok{"none"}\NormalTok{)}
\NormalTok{\})}

\CommentTok{\# now we can show only those genera that have at least score 5 (or 4 or 3 or 2 or 1)}
...
\includegraphics{30_differential_abundance_files/figure-latex/daplotting-1.pdf}
...
\NormalTok{  ancombc\_plots[[}\DecValTok{6}\NormalTok{]] }\SpecialCharTok{+}
  \FunctionTok{plot\_layout}\NormalTok{(}\AttributeTok{nrow =} \DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{30_differential_abundance_files/figure-latex/daplotting-2.pdf}
...
\hypertarget{ancombc}{%
\subsubsection{ANCOMBC}\label{ancombc}}
...
\NormalTok{phy }\OtherTok{\textless{}{-}} \FunctionTok{phyloseq}\NormalTok{(otu,taxa,meta)}
\CommentTok{\# perform the analysis }
\NormalTok{ancombc\_cov }\OtherTok{\textless{}{-}} \FunctionTok{ancombc}\NormalTok{(}
  \AttributeTok{phyloseq =}\NormalTok{ phy,}
  \AttributeTok{formula =} \StringTok{"Geographical\_location + Age"}\NormalTok{, }
  \AttributeTok{p\_adj\_method =} \StringTok{"fdr"}\NormalTok{, }
  \AttributeTok{lib\_cut =} \DecValTok{0}\NormalTok{, }
  \AttributeTok{group =} \StringTok{"Geographical\_location"}\NormalTok{, }
  \AttributeTok{struc\_zero =} \ConstantTok{TRUE}\NormalTok{, }
...
\FunctionTok{kable}\NormalTok{(}\FunctionTok{head}\NormalTok{(ancombc\_cov}\SpecialCharTok{$}\NormalTok{res}\SpecialCharTok{$}\NormalTok{q\_val))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{tse }\OtherTok{\textless{}{-}} \FunctionTok{transformCounts}\NormalTok{(tse, }\AttributeTok{assay\_name =} \StringTok{"counts"}\NormalTok{, }\AttributeTok{method =} \StringTok{"clr"}\NormalTok{,}
...
\CommentTok{\# Add clr{-}transformation on samples}
\NormalTok{tse\_phylum }\OtherTok{\textless{}{-}} \FunctionTok{transformCounts}\NormalTok{(tse\_phylum, }\AttributeTok{MARGIN =} \StringTok{"samples"}\NormalTok{, }\AttributeTok{method =} \StringTok{"clr"}\NormalTok{, }\AttributeTok{assay\_name =} \StringTok{"counts"}\NormalTok{, }\AttributeTok{pseudocount=}\DecValTok{1}\NormalTok{)}
...
\NormalTok{tse\_phylum\_subset }\OtherTok{\textless{}{-}} \FunctionTok{transformCounts}\NormalTok{(tse\_phylum\_subset, }\AttributeTok{method =} \StringTok{"clr"}\NormalTok{,}
                                     \AttributeTok{MARGIN=}\StringTok{"samples"}\NormalTok{,}
                                     \AttributeTok{assay\_name =} \StringTok{"counts"}\NormalTok{, }\AttributeTok{pseudocount=}\DecValTok{1}\NormalTok{)}
