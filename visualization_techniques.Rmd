...
`SCE` and `TSE` objects contain multiple layers of information in the form of rows, columns and meta data. The `scater` package supports in accessing, modifying and visualizing the meta data related to features as well as samples.
...
```{r, warning = FALSE}
# plot QC Mean against Sample ID, colur-labeled by Sample Type
...
Further methods of usage and examples can be found in the chapters \@ref(qc) and \@ref(richness).
