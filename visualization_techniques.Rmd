...
For more sophisticated visualizations than those produced with `plotAbundance` and `ggplot2`, the package `pheatmap` provides methods to include clusters in a heat map.
