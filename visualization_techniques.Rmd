...
A large variety of graphing methods belong to microbial analysis, but only few are the choices that will return useful answers about the data. Knowledge on the available tools and possible applications therefore plays an important role for the selection of the most suitable method for the asked question.
