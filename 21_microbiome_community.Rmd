...
# We already created clusters and dendogram for features
# taxa_clusters
# taxa_dendogram
...
# Hierarchical clustering
sample_clusters <- hclust(dist(t(mat)), method = "complete")

# Creates a dendrogram
sample_dendrogram <- as.dendrogram(sample_clusters)

# Creates clusters
sample_clusters <- cutree(tree = sample_dendrogram, k = 3)
...
# Create annotation plot
col_annotation <- ggplot(sample_types) + scale_y_discrete(position = "right", expand = c(0,0)) +
...
# Combine plots
plot <- row_annotation + heatmap + col_annotation + 
...
# Create a phylogenetic tree from dendrogram data
dendro_data <- as.phylo(taxa_dendrogram) 
...
# Create a phylogenetic tree from dendrogram data
dendro_data <- as.phylo(sample_dendrogram)
...
```{r more_complex_heatmap10, fig.width=10, fig.height=8}
# Combine plots
plot <- taxa_dendrogram + 
  row_annotation +
  sample_dendrogram + 
