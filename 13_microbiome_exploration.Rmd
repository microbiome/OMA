...
[Lahti L et al. (2014)](https://doi.org/10.1038/ncomms5344) dataset; `atlas1006`.

A Jitter plot using the top 25 taxa as a default value could be produced as follows: 
