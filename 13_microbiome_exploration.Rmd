...
[Lahti L et al. (2014)](https://doi.org/10.1038/ncomms5344) dataset.

A Jitter plot based on relative abundance data, similar to the one presented at 
[Salosensaari et al. 2021](https://www.nature.com/articles/s41467-021-22962-y) 
supplementary figure 1, could be visualized as follows: 
...
plotAbundanceDensity(tse, layout = "jitter", abund_values = "relabundance",
                     n = 40, point_size=1, point_shape=19, alpha=0.1) + 
    scale_x_log10(label=scales::percent)
```

Relative abundance values for top 5 taxa for instance can be visualized as a
...
plotAbundanceDensity(tse, layout = "density", abund_values = "relabundance",
                     n = 5, colour_by="nationality", alpha=1/10 ) +
    scale_x_log10()
```
## Session Info {-}
