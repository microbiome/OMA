...
lots of more data than phyloseq. **TreeSummarizedExperiment**. It extends
**SingleCellExperiment** class by providing slots for phylogenetic
tree and sample tree.
...
The [`SummarizedExperiment`](https://bioconductor.org/packages/release/bioc/html/SummarizedExperiment.html)
...
Recently, [`TreeSummarizedExperiment`](https://www.bioconductor.org/packages/release/bioc/html/TreeSummarizedExperiment.html) (`TSE`) were developed to extend the `SE` and `SCE` class for incorporating hierarchical
