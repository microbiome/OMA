...
# Get top taxa
rel_taxa <- getTopTaxa(tse, top = 8, abund_values = "counts")
...
tse <- transformCounts(tse, abund_values = "relabundance", method = "clr", pseudocount = 1)
tse <- transformFeatures(tse, abund_values = "clr", method = "z")
...
tse2 <- transformCounts(tse2, abund_values = "counts", method = "relabundance")
tse2 <- transformCounts(tse2, abund_values = "relabundance", method = "clr", pseudocount = 1)
tse2 <- transformFeatures(tse2, abund_values = "clr", method = "z")
# get top taxa
...
tse_dmn <- transformCounts(tse_dmn, abund_values = "counts", method = "relabundance")
tse_dmn <- transformCounts(tse_dmn, abund_values = "relabundance", method = "clr", pseudocount = 1)
tse_dmn <- transformFeatures(tse_dmn, abund_values = "clr", method = "z")
