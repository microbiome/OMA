...
tse <- transformCounts(tse, assay_name = "relabundance", method = "clr", pseudocount = 1)
tse <- transformFeatures(tse, assay_name = "clr", method = "z")
...
tse2 <- transformCounts(tse2, assay_name = "counts", method = "relabundance")
tse2 <- transformCounts(tse2, assay_name = "relabundance", method = "clr", pseudocount = 1)
tse2 <- transformFeatures(tse2, assay_name = "clr", method = "z")
# get top taxa
...
tse_dmn <- transformCounts(tse_dmn, assay_name = "counts", method = "relabundance")
tse_dmn <- transformCounts(tse_dmn, assay_name = "relabundance", method = "clr", pseudocount = 1)
tse_dmn <- transformFeatures(tse_dmn, assay_name = "clr", method = "z")
